...
This command **requires** the project directory as an argument via `/home/buckneri/projects/bwg-instagram-feed`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/home/buckneri/projects/bwg-instagram-feed/prompts/app_spec.txt` and `/home/buckneri/projects/bwg-instagram-feed/prompts/initializer_prompt.md`

If `/home/buckneri/projects/bwg-instagram-feed` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/home/buckneri/projects/bwg-instagram-feed/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/home/buckneri/projects/bwg-instagram-feed/prompts/app_spec.txt`
...
**Output path:** `/home/buckneri/projects/bwg-instagram-feed/prompts/initializer_prompt.md`
...
**Output path:** `/home/buckneri/projects/bwg-instagram-feed/prompts/.spec_status.json`
...
> "Your specification files have been created in `/home/buckneri/projects/bwg-instagram-feed/prompts/`!
>
> **Files created:**
> - `/home/buckneri/projects/bwg-instagram-feed/prompts/app_spec.txt`
> - `/home/buckneri/projects/bwg-instagram-feed/prompts/initializer_prompt.md`
>
